...
import static foundation.downloader.bizs.DLCons.DEBUG;
import static foundation.downloader.bizs.DLError.ERROR_INVALID_URL;
import static foundation.downloader.bizs.DLError.ERROR_NOT_NETWORK;
import static foundation.downloader.bizs.DLError.ERROR_REPEAT_URL;
 ...
 *         修改多线程任务的线程数量设置机制，每个任务可以自定义设置下载线程数量；
...
public final class DLManager {
    ...
    private DLManager(Context context, String dir) {
        this.context = context;
        this.defaultDir = dir;
    }

    public static DLManager initialize(Context context, String dir) {
        if (null == sManager) {
            sManager = new DLManager(context, dir);
        }
        return sManager;
    }
