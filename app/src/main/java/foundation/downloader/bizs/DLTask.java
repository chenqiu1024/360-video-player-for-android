...
import static foundation.downloader.bizs.DLCons.Base.DEFAULT_TIMEOUT;
import static foundation.downloader.bizs.DLCons.Base.LENGTH_PER_THREAD;
import static foundation.downloader.bizs.DLCons.Base.MAX_REDIRECTS;
import static foundation.downloader.bizs.DLCons.Code.HTTP_MOVED_PERM;
import static foundation.downloader.bizs.DLCons.Code.HTTP_MOVED_TEMP;
import static foundation.downloader.bizs.DLCons.Code.HTTP_NOT_MODIFIED;
import static foundation.downloader.bizs.DLCons.Code.HTTP_OK;
import static foundation.downloader.bizs.DLCons.Code.HTTP_PARTIAL;
import static foundation.downloader.bizs.DLCons.Code.HTTP_SEE_OTHER;
import static foundation.downloader.bizs.DLCons.Code.HTTP_TEMP_REDIRECT;
import static foundation.downloader.bizs.DLError.ERROR_OPEN_CONNECT;
