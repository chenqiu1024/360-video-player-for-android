...
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_CURRENT_BYTES;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_DIR_PATH;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_DISPOSITION;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_ETAG;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_FILE_NAME;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_LOCATION;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_MIME_TYPE;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_TOTAL_BYTES;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_URL_BASE;
import static foundation.downloader.bizs.DLCons.DBCons.TB_TASK_URL_REAL;
