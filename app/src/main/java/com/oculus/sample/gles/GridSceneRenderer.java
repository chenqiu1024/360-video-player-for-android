 ...
 */
public class GridSceneRenderer {
    ...
    public GridSceneRenderer(Context context) {
        ...
        grids = new Grids(SPHERE_SLICES, 0.f, 0.f, 0.f, SPHERE_RADIUS, SPHERE_INDICES_PER_VERTEX);
        ...
        GLES20.glVertexAttribPointer(aPositionLocation, 3,
                GLES20.GL_FLOAT, false, grids.getVerticesStride(), grids.getVertices());
        ...
        GLES20.glVertexAttribPointer(aTextureCoordLocation, 2,
                GLES20.GL_FLOAT, false, grids.getVerticesStride(),
                grids.getVertices().duplicate().position(3));
        GLHelpers.checkGlError("glVertexAttribPointer");
    }
    ...
    public void onDrawFrame(
        ...
        for (int j = 0; j < grids.getNumIndices().length; ++j) {
            GLES20.glDrawElements(GLES20.GL_TRIANGLES,
                    grids.getNumIndices()[j], GLES20.GL_UNSIGNED_SHORT,
                    grids.getIndices()[j]);
        }
    }
