...
public:
    ...
    void render(int filterID, int x, int y, int width, int height, GLint sourceTexture, GLenum sourceTextureTarget);
...
//    void render(int filterID, int x, int y, int width, int height, GLint sourceTexture, GLenum sourceTextureTarget, GLFilterOrientation sourceOrientation);
    ...
    void render(int filterID, int x, int y, int width, int height, GLint sourceTexture, GLenum sourceTextureTarget, Orientation2D sourceOrientation, Vec2f texcoordOrigin, Vec2f texcoordSize);
